...
iris_training = pd.read_csv("/home/chetna/Desktop/Masters/Master-Sem3/ML/irisdataset/IrisTraining_corrupted2.csv")
...
print(features)
target_names=["Iris-setosa","Iris-versicolor","Iris-virginica","IamCorrupted"];
...
print("Corrupted data by adding noise in label...output is:")
count0=0;
count1=0;
count2=0;
count3=0;
...
col3=[0, 0 , count2 , 0]
col4=[0, 0, 0,count3]		
df=pd.DataFrame({'Iris-setosa':col1, 'Iris-versicolor':col2, 'Iris-virginica': col3 ,'IamCorrupted':col4}, index=target_names)
print(df)